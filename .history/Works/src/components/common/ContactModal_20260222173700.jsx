...
const impactCardPop = keyframes`
  ...
  40% {
    opacity: 1;
    transform: perspective(1000px) scale(1.15) rotateY(-15deg) translateY(-40px);
    box-shadow: 0 0 100px rgba(0, 242, 96, 1);
  }
  70% {
    transform: perspective(1000px) scale(0.95) rotateY(5deg) translateY(10px);
    box-shadow: 0 40px 80px rgba(0, 0, 0, 0.95), 0 0 80px rgba(0, 242, 96, 0.3);
  }
  100% {
    opacity: 1;
    transform: perspective(1000px) scale(1) rotateY(0deg) translateY(0);
